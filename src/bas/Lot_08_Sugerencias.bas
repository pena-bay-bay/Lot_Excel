        ...
        For i = 1 To datSelMetodos.Count
            ...
            If mModel.GetRecord(mCurrentId) Then
                ...
                If Not (mSuge Is Nothing) Then
                    '
                    '   Sugerencia no tiene Id
                    '
                    mSuge.Entidad.Id = mCurrentId
  ...
  On Error GoTo DisLiterales_Error
    ...
    Else
        ...
        Select Case datSorteo.Juego
            Case Bonoloto: ActiveCell.Offset(2, 1).Value = "BL"
            Case LoteriaPrimitiva: ActiveCell.Offset(2, 1).Value = "LP"
            Case Euromillones: ActiveCell.Offset(2, 1).Value = "EU"
            Case GordoPrimitiva: ActiveCell.Offset(2, 1).Value = "GP"
        End Select
    ...
    If Not (datSorteo Is Nothing) Then
        ...
        Case Euromillones:
            ...
            For i = 1 To datSorteo.Combinacion.Count
                ...
                ActiveCell.Offset(1, i).Interior.ColorIndex = COLOR_VERDE
            Next i
            For i = 1 To datSorteo.Estrellas.Count
                n = datSorteo.Combinacion.Numeros(i).Valor
                ActiveCell.Offset(0, i).Value = "N" & i
                ActiveCell.Offset(1, i).Value = n
                ActiveCell.Offset(1, i).Interior.ColorIndex = COLOR_ANARANJADO
            Next i
        ...
        Case GordoPrimitiva:
            ...
            Next i
            i = i + 1
            n = datSorteo.Reintegro
            ActiveCell.Offset(0, i).Value = "R"
            ActiveCell.Offset(1, i).Value = n
            ActiveCell.Offset(1, i).Interior.ColorIndex = COLOR_AÑIL
        End Select
    End If
    '
    '   Metodo
...
Private Sub DisSugerencia(datSuge As Sugerencia, _
    ...
    Dim mCuValidar  As ComprobarSugerencia
  ...
  On Error GoTo DisSugerencia_Error
    ...
    '
    '
    ActiveCell.Offset(datLinea, 0).Value = "#" & CStr(datSuge.Entidad.Id)
    ...
    If Not (datSorteo Is Nothing) Then
        ...
        '
        Set mCuValidar = New ComprobarSugerencia
        Set mCuValidar.Sorteo = datSorteo
        mCuValidar.ComprobarSugerencia datSuge
        If mCuValidar.EstaPremiada Then
            ActiveCell.Offset(datLinea, 12).Value = mCuValidar.CategoriaPremioTxt
        Else
            ActiveCell.Offset(datLinea, 12).Value = mCuValidar.NumerosAcertados
        End If
    ...
    '   Metodo aplicado
    '
    ActiveCell.Offset(datLinea, 13).Value = datSuge.Metodo
