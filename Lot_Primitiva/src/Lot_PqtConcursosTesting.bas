...
Private Sub PremiosTest()
  ...
  On Error GoTo PremiosTest_Error
    ...
    Set mPrem = mObj.Item(4)
    PrintPremio mPrem
    '
    '   Caso de pruebas 07: IndexOf
    '
    Debug.Print " Prueba IndexOf ----------"
    Debug.Print "Index of (" & mPrem.ToString & " )= " & mObj.IndexOf(mPrem)
    '
    '   Caso de pruebas 08: IndexOf
    '
    Debug.Print " Prueba IndexOf ----------"
  ...
  On Error GoTo SorteoEngineTest_Error
    ...
    If Not (mSorteo Is Nothing) Then
        If mSorteo.Fecha = mFecha Then
            Debug.Print ("Prueba Correcta, sorteo localizado: " & mSorteo.Texto)
            PrintSorteo mSorteo
        Else
            Debug.Print ("#Error en GetSorteoByFecha : " & mSorteo.Texto)
        End If
    Else
...
Private Sub PrintSorteo(oSorteo As Sorteo)
    ...
    Debug.Print "Id                   = " & oSorteo.EntidadNegocio.Id
    ...
    Debug.Print "Registro             = " & oSorteo.Registro
    Debug.Print "Reintegro            = " & oSorteo.Reintegro
    Debug.Print "Semana               = " & oSorteo.Semana
    Debug.Print "Texto                = " & oSorteo.Texto
    Debug.Print "TipoJuego            = " & oSorteo.TipoJuego
